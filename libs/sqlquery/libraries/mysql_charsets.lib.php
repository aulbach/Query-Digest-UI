 ...
 */
    ...
    */
    ...
    $data = $dbh->prepare('SHOW CHARACTER SET');
    $data->execute();
    while($charset = $data->fetch(PDO::FETCH_ASSOC))
    {
    	$mysql_charsets[] = $charset['Charset'];
    	$mysql_charsets_descriptions[$charset['Charset']] = $charset['Description'];
    }
    unset($data);
    ...
    */
    ...
    $data = $dbh->prepare('SHOW COLLATION');
    $data->execute();
